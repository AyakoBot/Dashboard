										...
										>
											<div class="relative w-5 h-5 flex items-center justify-center">
												{#if server.isFavorite}
													<span class="i-tabler-star-filled text-xl text-yellow-400 drop-shadow-[0_0_8px_rgba(250,204,21,0.5)]"></span>
												{:else}
													<span class="i-tabler-star text-xl text-white/30 block group-hover/star:hidden"></span>
													<span class="i-tabler-star-filled text-xl text-yellow-400 hidden group-hover/star:block absolute inset-0 drop-shadow-[0_0_8px_rgba(250,204,21,0.3)]"></span>
												{/if}
											</div>
										</button>
										{:else}
