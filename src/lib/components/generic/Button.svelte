<script lang="ts">
 ...
 const sizeClasses = {
 xs: 'px-2.5 py-1 text-xs min-h-[24px]',
 ...
 const base = 'relative font-medium transition-all duration-200 transform focus:outline-none focus:ring-2 focus:ring-offset-2';
