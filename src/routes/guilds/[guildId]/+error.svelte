...
<div
 class="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-main-darkest via-main-darker to-main-dark"
>
 <div
  class={clsx(
   'max-w-md w-full',
 ...
 >
  <div class="text-center">
   <div class="relative inline-block mb-6">
    ...
    {#if status === 403}
     <div
      class="absolute -bottom-1 -right-1 w-8 h-8 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center shadow-lg"
     >
     ...
     <div class="flex items-start gap-3">
      ...
      <div class="text-left">
       <p class="text-sm text-white/80 mb-2">
        To manage this server, you need the <span class="font-semibold text-orange-400"
         >Manage Server</span
        > permission.
       </p>
