<script lang="ts">
	...
	const fonts = [
		{ name: 'Poppins', class: 'font-poppins', sample: 'The quick brown fox jumps over the lazy dog', usage: 'Primary font for headings and body text' },
		{ name: 'Code Font', class: 'code-font', sample: 'const hello = "world";', usage: 'IBM Plex Mono for code blocks' },
		{ name: 'Serif', class: 'font-serif', sample: 'Elegant serif typography', usage: 'DM Serif Display for decorative text' },
		{ name: 'Mono', class: 'font-mono', sample: 'Monospaced text example', usage: 'DM Mono for technical content' },
		{ name: 'Clock', class: 'font-clock', sample: '12:34:56', usage: 'Bungee Outline for time displays' },
	...
	<div class="max-w-7xl mx-auto">
		...
		<div class="mb-8">
			...
			<p class="text-white/60">
				Comprehensive reference of all design tokens, components, patterns, and utilities used in the Ayako Dashboard.
			</p>
		</div>
		...
		<div class="mb-8 flex gap-2 p-1 bg-white/5 rounded-lg">
			<button
				...
				class={clsx(
					...
					selectedTab === 'colors' ? 'bg-primary-500 text-white' : 'text-white/60 hover:text-white hover:bg-white/5'
				)}
			>
				Colors
			</button>
			<button
				...
				class={clsx(
					'px-4 py-2 rounded-lg transition-all duration-200',
					selectedTab === 'components' ? 'bg-primary-500 text-white' : 'text-white/60 hover:text-white hover:bg-white/5'
				)}
			>
				Components
			</button>
			<button
				...
				class={clsx(
					'px-4 py-2 rounded-lg transition-all duration-200',
					selectedTab === 'patterns' ? 'bg-primary-500 text-white' : 'text-white/60 hover:text-white hover:bg-white/5'
				)}
			>
				Patterns
			</button>
			<button
				...
				class={clsx(
					'px-4 py-2 rounded-lg transition-all duration-200',
					selectedTab === 'utilities' ? 'bg-primary-500 text-white' : 'text-white/60 hover:text-white hover:bg-white/5'
				)}
			>
				Utilities
			</button>
		...
		<section class="space-y-12">
			<Card title="Color System" description="Complete color palette with hex values and usage guidelines">
				{#snippet children()}
				<!-- Primary Colors -->
				<div class="mb-8">
			...
			<Card title="Error Responses" description="Standard HTTP error templates used across the dashboard">
				{#snippet children()}
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
					{#each errorDefinitions as definition}
					<div class="relative p-4 rounded-xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/10 overflow-hidden">
						<div class={clsx(
		...
		<section class="space-y-8">
			...
			<Card title="Button System" description="All button variants with hover and active states">
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
					...
					<div class="p-4 rounded-lg bg-white/5 border border-white/10 flex justify-between items-center">
			...
			<Card title="Form Controls" description="Input fields and interactive elements">
				...
				<div class="space-y-6 max-w-md">
					...
					<div>
						...
						<input id="designs-glass-input" type="text" class="input-glass" placeholder="Glass style input..." />
					</div>
					
					<div>
						<label for="designs-feature-toggle" class="block text-sm text-white/60 mb-2">Switch Toggle</label>
		...
		<section class="space-y-8">
			...
			<!-- State Management -->
			<Card title="State Management Patterns" description="Common application states and their handling">
				{#snippet children()}
		...
		<section class="space-y-8">
			...
			<Card title="Shadow Effects" description="Elevation and depth through shadows">
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
					...
					<div class={clsx(
						'bg-main-dark rounded-lg p-6 border border-white/10',
						shadow.class
					)}>
				...
				<div class="p-6 rounded-lg bg-white/5 border border-white/10">
					<div class="grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-4">
						...
						<button
							...
							title={icon}
						>
							<span class={clsx(icon, 'text-2xl text-white/80 group-hover:text-white transition-colors')}></span>
			...
			<Card title="Responsive Breakpoints" description="Tailwind-based responsive design breakpoints">
				...
				<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
					{#each [
						{ name: 'xs', size: '475px', usage: 'Small mobile' },
						{ name: 'sm', size: '640px', usage: 'Mobile' },
						{ name: 'md', size: '768px', usage: 'Tablet' },
						{ name: 'lg', size: '1024px', usage: 'Desktop' },
						{ name: 'xl', size: '1280px', usage: 'Large desktop' },
						{ name: '2xl', size: '1536px', usage: 'Extra large' },
					] as breakpoint}
		...
		<div class="mt-16 p-6 rounded-lg bg-white/5 border border-white/10">
			<div class="flex items-start gap-3">
				...
				<div class="text-sm text-white/60">
					<p class="mb-2">
						<strong class="text-white">Living Documentation:</strong> This page automatically reflects the current state of the design system.
					</p>
					<p class="mb-2">
						All components, patterns, and utilities shown here are actively used in production. Changes to the design system should be documented here.
					</p>
					<p>
						<strong class="text-white">Usage:</strong> Click on any color or class name to copy it to your clipboard for quick implementation.
					</p>
				</div>
			</div>
		</div>
