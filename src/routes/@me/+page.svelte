...
<div class="min-h-screen bg-gradient-to-br from-main-darkest via-main-darker to-main-dark">
 ...
 <div class="absolute bottom-20 right-20 w-96 h-96 bg-accent-purple/10 rounded-full blur-3xl"></div>
 </div>
 ...
 {#if showWelcome && data.user}
  ...
  <div class="flex items-start justify-between">
   ...
   <p class="text-white/70">
    Here's your dashboard overview. Navigate through features using the sidebar or quick actions below.
   </p>
   </div>
   <button
 ...
 <header class="mb-8">
  ...
  <div class="relative lg:w-96">
   ...
   <kbd class="absolute right-4 top-3 px-2 py-1 text-xs bg-white/10 rounded border border-white/20 text-white/60">
   /
   </kbd>
  </div>
  </div>
 ...
 <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
  ...
  <div class={clsx(
   ...
   <div class="space-y-3">
    ...
    >
     ...
     <button class="text-white/30 hover:text-white/60 transition-colors" aria-label="More options for {activity.message}">
  ...
  <div class={clsx(
   ...
   >
    ...
    <span class="i-tabler-chevron-right text-white/30 group-hover:text-white/60 transition-colors"></span>
    </div>
   </a>
  ...
  <div class={clsx(
   ...
   Use keyboard shortcuts to navigate faster. Press <kbd class="px-1.5 py-0.5 bg-white/10 rounded text-xs">?</kbd> to see all shortcuts.
   </p>
  </div>
  </div>
 </div>
