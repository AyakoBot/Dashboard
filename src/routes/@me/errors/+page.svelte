   ...
   <div class="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
    <div class="flex items-center gap-2">
     ...
     <p class="text-sm text-yellow-200">
      Warning: Clicking these buttons will trigger actual error pages and navigate away from this
      page.
     </p>
    </div>
   </div>
    ...
    {#each errorDefinitions as definition}
     ...
     >
      ...
      <div class="relative z-10">
       <div class={clsx('flex items-center gap-3 mb-3')}>
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <button
     onclick={() =>
      triggerError(
       451,
       'Unavailable For Legal Reasons - This content has been removed due to legal requirements.'
      )}
     class={clsx(
      'p-4 rounded-xl text-left',
      'bg-gradient-to-br from-white/[0.08] to-white/[0.02]',
