...
<div
 class="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-main-darkest via-main-darker to-main-dark relative overflow-hidden"
>
 ...
 <div class="max-w-2xl w-full relative z-10">
  ...
  <div class="text-center mb-8 flex flex-col items-center gap-4">
   ...
   <span class={clsx(details.icon, 'text-6xl', details.color, 'animate-bounce', 'drop-shadow-2xl')}
   ></span>
  </div>
  ...
  >
   ...
   <div class="text-center mb-8">
    <h1
     class={clsx(
      ...
      'bg-gradient-to-r',
      details.bgGradient.replace(/\/20/g, ''),
   ...
   <details class="mb-8 group">
    <summary
     class="cursor-pointer text-sm text-white/40 hover:text-white/60 transition-colors flex items-center gap-2"
    >
     ...
     <div class="grid grid-cols-2 gap-4 text-sm">
      ...
      {#if error?.stack && error.stack !== error.message}
       <div class="col-span-2">
        ...
        <pre class="text-white/60 mt-2 text-xs font-mono overflow-x-auto">{error.stack.slice(
          0,
          200
         )}...</pre>
       </div>
   ...
   <div class="flex flex-col sm:flex-row gap-3">
    ...
    >
     <span
      class="i-tabler-clipboard text-lg group-hover:scale-110 transition-transform inline-block"
     ></span>
  ...
  <div class="text-center mt-8 text-sm text-white/40">
   Need help?
   <a
    href="https://discord.com/channels/298954459172700181/996850314357522452"
